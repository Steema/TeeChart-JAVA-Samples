 ...
 *
 */
public class StochasticDemo extends ChartSample implements ModifyListener, SelectionListener {

    private Candle sourceSeries;
    private Stochastic function;
    
	public StochasticDemo(Composite c) {
		super(c);
	...
	protected void createContent() {
		super.createContent();
        activeButton = addCheckButton("Show Stochastic", "", this);        
	...
	protected void initChart() {
        ...
        function = new com.steema.teechart.functions.Stochastic(chart1.getChart());
