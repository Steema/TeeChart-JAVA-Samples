 ...
 *
 */
public class HorizBarDemo extends ChartSample implements SelectionListener {

	public HorizBarDemo(Composite c) {
		super(c);
	...
	public void widgetSelected(SelectionEvent se) {	
        ...
        if (source == layoutList) {
            ...
            switch (layoutList.getSelectionIndex()) {
            ...
            switch (barStyleList.getSelectionIndex()) {
	...
	protected void createContent() {
		...
		layoutList = addCombo(SWT.SINGLE | SWT.READ_ONLY);
		addLabel(SWT.LEFT, "Style Bar 1: ");		
		barStyleList = addCombo(SWT.SINGLE | SWT.READ_ONLY);		
